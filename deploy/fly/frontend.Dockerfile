...
ARG NEXT_PUBLIC_ROSS_DATA_BOUNDARY_VERSION=2026-09-03-provider-responsibility
ARG NEXT_PUBLIC_ROSS_SIGNUPS_ENABLED=false
ARG NEXT_PUBLIC_ROSS_TERMS_VERSION=2026-09-03-provider-responsibility
ARG NEXT_PUBLIC_ROSS_PRIVACY_VERSION=2026-09-03-provider-responsibility
...
ENV NEXT_TELEMETRY_DISABLED=1 \
    ...
    NEXT_PUBLIC_ROSS_TERMS_VERSION=${NEXT_PUBLIC_ROSS_TERMS_VERSION} \
    NEXT_PUBLIC_ROSS_PRIVACY_VERSION=${NEXT_PUBLIC_ROSS_PRIVACY_VERSION}
